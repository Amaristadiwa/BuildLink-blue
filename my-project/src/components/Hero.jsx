...
export const Hero = () => {
  return (
    <section
      className="relative w-screen h-screen bg-cover bg-center flex items-center overflow-hidden"
    ...
    >
      ...
      <div className="relative mx-auto px-6 sm:px-8 z-10 text-white max-w-3xl">
...
export const HeroWithSearch = () => {
  return (
    <>
      ...
      <div className="w-screen px-4 sm:px-6 -mt-12 relative z-20">
        <div className="max-w-5xl mx-auto bg-white/90 backdrop-blur-md p-4 sm:p-5 rounded-xl shadow-lg">
